...
\begin{abstract}
This package provides support for generating small, horizontal bar data graphics, in the spirit of the data graphics discussed from Edward Tufte's ``The Visual Display of Quantitative Information''.  For example, here is a bar set at 50\% of the default width with error bars set at 25\%: \mbarerr{50}{0.25}.
\end{abstract}
